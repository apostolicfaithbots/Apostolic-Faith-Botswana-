...
export default function App() {
  ...
  async function fetchData() {
    try {
      const [eventsRes, announcementsRes, sermonsRes] = await Promise.all([
      ...
      console.log('Using fallback data - Supabase tables may not exist yet')
  ...
  return (
    <>
      ...
      <main>
        <Routes>
          <Route path="/" element={
            <HomePage events={events} announcements={announcements} sermons={sermons} loading={loading} />
          } />

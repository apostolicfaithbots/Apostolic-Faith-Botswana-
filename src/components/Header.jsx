    ...
    <header style={{
      ...
      <div style={{
        ...
        <button onClick={() => setMenuOpen(!menuOpen)} className="mobile-menu-btn"
          style={{ display: 'none', color: '#fff', fontSize: '1.5rem', padding: '0.5rem', background: 'none', border: 'none', cursor: 'pointer' }}
          aria-label="Menu">
      ...
      <div style={{
        position: 'fixed', top: 0, right: 0, bottom: 0, width: '100%', maxWidth: '300px',
        background: 'var(--color-gray-900)', transform: menuOpen ? 'translateX(0)' : 'translateX(100%)',
        transition: 'transform 0.4s cubic-bezier(0.16,1,0.3,1)',
        padding: '5rem 2rem 2rem', display: 'flex', flexDirection: 'column', gap: '0.15rem', zIndex: 999,
      }}>
      ...
      {menuOpen && <div onClick={() => setMenuOpen(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 998 }} />}
